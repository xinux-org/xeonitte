...
pub const VTE_MINOR_VERSION: c_int = 72;
...
extern "C" {
    ...
    pub fn vte_terminal_check_hyperlink_at(
    ...
    #[cfg(feature = "v0_70")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_70")))]
    pub fn vte_terminal_check_match_at(
        terminal: *mut VteTerminal,
        x: c_double,
        y: c_double,
        tag: *mut c_int,
    ...
    #[cfg(feature = "v0_70")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_70")))]
    pub fn vte_terminal_check_regex_array_at(
        terminal: *mut VteTerminal,
        x: c_double,
        y: c_double,
    ...
    #[cfg(feature = "v0_70")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_70")))]
    pub fn vte_terminal_check_regex_simple_at(
        terminal: *mut VteTerminal,
        x: c_double,
        y: c_double,
        regexes: *mut *mut VteRegex,
